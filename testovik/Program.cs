...
namespace testovik
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            commands.Add(new choose());commands.Add(new show());commands.Add(new del());
        ...
        public static async void OnMessageHandler(object sender, MessageEventArgs e)
        {
            ...
            if (msg.Text!=null)
            {
                ...
                else if (msg.Text.StartsWith("/del") && msg.Text!="/del" && !msg.Text.StartsWith("/del@"))
                {
                    ...
                    {
                        await client.SendTextMessageAsync(msg.Chat.Id,"@"+userstor.getu(i)+" удалён\n\n"+vvedite,replyMarkup:new ReplyKeyboardRemove());
                        userstor.deluser(i);
                    }
                ...
                else if (msg.Text.StartsWith("@") && !msg.Text.StartsWith("@ "))
                {
                    if (Addu.active == true)
                    {
                        ...
                        await client.SendTextMessageAsync(msg.Chat.Id,"@"+userstor.getu(userstor.count-1)+" is added\n\n");
