...
namespace testovik
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            commands.Add(new show());commands.Add(new del()); Addu=new addu(); Start=new start();
        ...
        public static async void OnMessageHandler(object sender, MessageEventArgs e)
        {
            ...
            if (msg.Text!=null)
            {
                ...
                else if (msg.Text.StartsWith("/del") && msg.Text!="/del" && !msg.Text.StartsWith("/del@"))
                {
                    ...
                    if (Addu.active==true) Addu.stopex(msg,client); savestor(userstor);
                }
                ...
                else if (msg.Text.StartsWith("@") && !msg.Text.StartsWith("@ "))
                {
                    if (Addu.active==true)
                    {
                        ...
                        Addu.stopex(msg,client); savestor(userstor); 
                    }
                }
